...
The methodology used to develop `carculator_two_wheeler` is explained in:
carculator_two_wheeler: an open-source tool for prospective environmental and economic life cycle assessment of vehicles. When, Where and How can battery-electric vehicles help reduce greenhouse gas emissions?
...
More specifically, ``carculator_two_wheeler`` generates `Brightway2 <https://brightwaylca.org/>`_ and `SimaPro <https://simapro.com/>`_ inventories, but also directly provides characterized
...
``carculator_two_wheeler`` is a Python package, and is primarily to be used from within a Python 3.x environment.
Because ``carculator_two_wheeler`` is still at an early development stage, it is a good idea to install it in a separate environment,
...
Note: many examples are given in this `notebook <https://github.com/romainsacchi/carculator_two_wheeler/blob/master/examples/Examples.ipynb>`_ that you can run directly on your computer..
...
the values to change, following `this template <https://github.com/romainsacchi/carculator_two_wheeler/raw/master/docs/template_workbook.xlsx>`_.
...
.. image:: https://github.com/romainsacchi/carculator_two_wheeler/raw/master/docs/stochastic_example_ttw.png
    :width: 400
    :alt: Alternative text
...
.. image:: https://github.com/romainsacchi/carculator_two_wheeler/raw/master/docs/example_noise_emissions.png
    :width: 400
    :alt: Alternative text
...
.. image:: https://github.com/romainsacchi/carculator_two_wheeler/raw/master/docs/example_carbon_footprint.png
    :width: 400
    :alt: Alternative text
...
.. image:: https://github.com/romainsacchi/carculator_two_wheeler/raw/master/docs/example_stochastic_BEV_PHEV.png
    :width: 400
    :alt: Alternative text
